             <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    <h2><?php echo $this->lang->line("New"); ?> <?php echo $this->lang->line("Repository"); ?></h2>
                    <ol class="breadcrumb">
                        <li>
                        ...
                        <li class="active">
                            <strong><?php echo $this->lang->line("New"); ?> <?php echo $this->lang->line("Repository"); ?></strong>
                        </li>
                    </ol>
                </div>
                <div class="col-lg-2">
                ...
                <div class="col-lg-12">
                    <div class="ibox">
                        <div class="ibox-title">
                            <h5><?php echo $this->lang->line("New"); ?> <?php echo $this->lang->line("Repository"); ?></h5>
                        ...
                        <div class="ibox-content">
                            <h2>
                                <?php echo $this->lang->line("New"); ?> <?php echo $this->lang->line("Repository"); ?>
                            </h2>
                            <?php echo form_open('marathon/RepoNew', 'method="POST" class="wizard-big" id="form"');?>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-8">
                                            <div class="form-group">
                                                ...
                                                <input id="maxruntime" name="maxruntime" placeholder="120" type="text" class="form-control number required">
                                            </div>
                                            <div class="form-group">
                                                <label><?php echo $this->lang->line("Max_Ram"); ?> (Mb) *</label>
                                                <input id="maxram" name="maxram" type="text" placeholder="300" class="form-control number required">
                                            </div>
                                            <div class="form-group">
                                                <label><?php echo $this->lang->line("Max_Output"); ?> (Mb) *</label>
                                                <input id="maxoutput" name="maxoutput" type="text" placeholder="200" class="form-control number required">
                                            </div>
                                        </div>
                                        <div class="col-lg-4">
                                            <div class="text-center">
	                                	...
	                                	<table class="table table-striped table-bordered table-hover dataTables-problems" >
						                    ...
						                    <?php foreach( (array)$problems as $row ): ?>
						                        <tr>
						                            ...
						                            <td><input type="checkbox" name="problems[]" value="<?php echo $row['id']; ?>" class="js-switch" ></td>
						                        </tr>
						                    <?php endforeach; ?>
						                    </tbody>
						                    <tfoot>
                                        ...
                                        <table class="table table-striped table-bordered table-hover dataTables-languages" >
                                            ...
                                            <?php foreach( (array)$languages as $row ): ?>
                                                <tr>
                                                    <td><?php echo $row['id']; ?></td>
                                                    <td><?php echo $row['name']; ?></td>
                                                    <td><input type="checkbox" name="languages[]" value="<?php echo $row['id']; ?>" class="js-switch"></td>
                                                </tr>
                                            <?php endforeach; ?>
                                            </tbody>
                                            <tfoot>
