        ...
        <div class="wrapper wrapper-content animated fadeInRight">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <?php foreach((array)$marathon as $row ): ?>
                        <tr>
                            ...
                            <td><button onclick="$('#edit').val(<?php echo $row['id']; ?>);$('#id').text(<?php echo $row['id']; ?>);$('#marathon').text('<?php echo $row['name']; ?>');" type="button" class="btn btn-outline btn-warning" data-toggle="modal" data-target="#editMarathon">Edit</button></td>
                        </tr>
                    <?php endforeach; ?>
                    </tbody>
                    <tfoot>
            ...
            <div class="modal inmodal fade" id="editMarathon" tabindex="-1" role="dialog"  aria-hidden="true">
                <div class="modal-dialog modal-sm">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title"><?php echo $this->lang->line("Edit"); ?> <?php echo $this->lang->line("Marathon"); ?></h4>
                        </div>
                        <div class="modal-body">
                            <p><strong><?php echo $this->lang->line("Are_you_sure"); ?> <?php echo $this->lang->line("Edit"); ?> <?php echo $this->lang->line("Marathon"); ?>:</strong></p>
                            <p><strong>Id: <b id="id"></b></strong></p>
                            <p><strong><?php echo $this->lang->line("Name"); ?>: <b id="marathon"></b></strong></p>
                        </div>
                        <?php echo form_open('marathon/EditMarathon', 'method="POST" class="form-horizontal"');?>
