            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    <h2><?php echo $this->lang->line("Problems_Deleted"); ?></h2>
                    <ol class="breadcrumb">
                        <li>
                        ...
                        <li class="active">
                            <strong><?php echo $this->lang->line("Problems_Deleted"); ?></strong>
                        </li>
                    </ol>
                </div>
                <div class="col-lg-2">
                ...
                <div class="modal-dialog modal-sm">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <p><strong><?php echo $this->lang->line("Are_you_sure"); ?> <?php echo $this->lang->line("Deleted"); ?> <?php echo $this->lang->line("Problem"); ?>:</strong></p>
                            <p><strong>Id: <b id="id"></b></strong></p>
                            <p><strong><?php echo $this->lang->line("Name"); ?>: <b id="problem"></b></strong></p>
                        </div>
                        <?php echo form_open('user/problem_deleted_check', 'method="POST" class="form-horizontal"');?>
