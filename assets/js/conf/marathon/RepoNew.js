 $(document).ready(function()
{
            ...
            $("#form").steps({
                ...
                onFinished: function (event, currentIndex)
                {
                    ...
                    var ProblemsTable = $('.dataTables-problems').dataTable();
                    $('#form').append($("input:checked", ProblemsTable.fnGetNodes()));

                    var LanguageTable = $('.dataTables-languages').dataTable();
                    $('#form').append($("input:checked", LanguageTable.fnGetNodes()));
